  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100">New Time Entry</h1>
          ...
          <div className="mb-4">
            ...
            {selectedClientId && filteredProjects.length === 0 && (
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                ...
                <Link href="/projects/new" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                  Create one?
                </Link>
              </p>
            )}
