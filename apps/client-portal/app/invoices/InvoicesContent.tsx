  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">View and track your invoices</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow dark:shadow-gray-900">
          ...
          <p className="text-2xl font-bold text-red-600 dark:text-red-500">{getOverdueCount()}</p>
        </div>
      </div>
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {invoices.map((invoice) => (
                  <tr key={invoice.id} className={invoice.isOverdue ? 'bg-red-50 dark:bg-red-900/10' : ''}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                      ...
                      {invoice.isOverdue && (
                        <div className="text-red-600 dark:text-red-400 font-medium text-xs mt-1">Overdue</div>
                      )}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={getStatusBadgeClass(invoice.status, invoice.isOverdue || false)}>
                        {invoice.isOverdue && invoice.status !== 'paid' && invoice.status !== 'cancelled' ? 'OVERDUE' : invoice.status.toUpperCase()}
                      </span>
                    </td>
